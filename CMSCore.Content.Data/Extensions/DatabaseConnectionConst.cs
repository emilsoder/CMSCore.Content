namespace CMSCore.Content.Data.Extensions
{
    public class DatabaseConnectionConst
    {
        ...
        public const string SqlServer =
            "Data Source=STO-PC-681;Initial Catalog=cmscore-content_v2;Integrated Security=False;User ID=cmscore;Password=123QWEasd!;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
